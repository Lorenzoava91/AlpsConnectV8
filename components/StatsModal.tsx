...
const StatsModal: React.FC<Props> = ({ isOpen, onClose }) => {
  ...
  if (!isAuthenticated) {
    return (
      <div className="fixed inset-0 z-[1200] flex items-center justify-center p-4 bg-slate-900/90 backdrop-blur-md animate-in fade-in duration-200">
  ...
  // --- DASHBOARD SCREEN ---
  return (
    <div className="fixed inset-0 z-[1200] flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-md animate-in fade-in duration-200">
